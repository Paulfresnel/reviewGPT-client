...
function HomePage(){
    ...
    return(
        <div className='margined'>
            ...
            <br/>
            <p>For your <br/><br/> <span className="special colored">Events</span>, <br/> <span className="special colored">Appartments</span>,<br/>  <span  className="special colored">Restaurants</span>, <br/>  <span  className="special colored">Stores</span>,<br/>  <span  className="special colored"> Company's physical presence</span></p>
